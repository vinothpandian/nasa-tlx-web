...
export const FETCH_ALL_EXPERIMENT_DATA_ASYNC = 'FETCH_ALL_EXPERIMENT_DATA_ASYNC';
...
export const fetchAllExperimentDataAsync = createAction(FETCH_ALL_EXPERIMENT_DATA_ASYNC);
